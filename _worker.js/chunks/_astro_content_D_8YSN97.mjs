...
import { o as objectType, g as dateType, h as arrayType, s as stringType, A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, a as renderTemplate, U as UnknownContentCollectionError, i as escape, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderComponent } from './astro/server_BwhXqllw.mjs';
...
import { u as unflatten } from './parse_B-ky88SW.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BvHboyy5.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BR-HtfSF.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CNn_Va-P.mjs');
