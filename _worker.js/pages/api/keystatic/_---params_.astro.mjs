  ...
  collections: {
    projects: collection({
      ...
      schema: {
        ...
        year: index.integer({ label: "Year" }),
        featured: index.checkbox({ label: "Featured", defaultValue: false }),
        order: index.integer({ label: "Order", defaultValue: 0 }),
        body: index.markdoc({ label: "Body" })
      }
    }),
    posts: collection({
      label: "Writing",
      ...
      schema: {
        ...
        category: index.text({ label: "Category" }),
        date: index.date({ label: "Date", validation: { isRequired: true } }),
        summary: index.text({ label: "Summary", multiline: true }),
        draft: index.checkbox({ label: "Draft", defaultValue: false }),
        ...
        content: index.markdoc({ label: "Body", extension: "md" })
      }
    })
  },
  singletons: {
    site: singleton({
      ...
      format: { data: "yaml" },
      schema: {
        tagline: index.text({ label: "Tagline", multiline: true }),
        intercomGreeting: index.text({ label: "Intercom greeting", multiline: true }),
        intercomSuggestions: index.array(index.text({ label: "Suggestion" }), {
          label: "Intercom suggestions",
          itemLabel: (props) => props.value || "Suggestion"
        }),
        email: index.text({ label: "Email" }),
        github: index.text({ label: "GitHub" }),
        availability: index.select({
          label: "Availability",
          options: [
